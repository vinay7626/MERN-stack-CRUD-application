...
This project aims to streamline the HR processes improve the data accuracy. This system is designed to streamline the storage and retrieval of the Employee Information with in the organization.
